...
int led = 13;
 ...
 boolean gatilloAntes = false;
 boolean gatilloDespues = false;  //
...
void loop() {
//boolean gatillo informacion true false
 gatilloAntes = gatilloDespues;  //false
 gatilloDespues = digitalRead(boton);    //mientras el gatillo sea false no se hace la captura

if(gatilloAntes == false && gatilloDespues == true){  
